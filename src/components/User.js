      ...
      <div class="md:items-center">
        ...
        {section1.map((item, index) => (
            <div className="rounded overflow-hidden shadow-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-102 duration-500"
                 style={index === 0 ? { width: '500px', height: '350px', backgroundImage: 'url("' + item.picture + '")', backgroundSize: 'cover' } : { marginLeft: 125, width: '250px', height: '175px', backgroundImage: 'url("'+item.picture+'")', backgroundSize: 'cover' }}>
